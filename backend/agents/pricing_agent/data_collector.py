...
Uses:
  ...
  2. Groq LLM to generate realistic benchmark data based on real-world conferences
"""
...
from .config import GROQ_API_KEY, GROQ_MODEL, SEED_DIR
from .schemas import EventContext, HistoricalEvent
...
class DataCollector:
    ...
    def _generate_benchmarks(self, ctx: EventContext) -> List[HistoricalEvent]:
        """Use Groq to generate realistic benchmark data."""
